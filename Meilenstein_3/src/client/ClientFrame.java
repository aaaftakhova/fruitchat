...
public class ClientFrame extends JFrame {
	...
	private DefaultListModel<String> onlineUserListModel = new DefaultListModel<String>();
	...
	public ClientFrame(final ChatClient c) {
		...
		mntmPrivateChat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {				
				String receiver = PrivateChatList.getUser(self, onlineUserListModel);
				if (receiver != null && receiver.length() > 0)
					c.openPrivateDialog(receiver);
			}
		});
	...
	public void update(String[] userArray, String[] roomArray) {
		...
		// filter user list, update onlineUsers
		for (String string : userArray) {
			//
			//room online users filtering
